...
class parser:
    ...
    def expression(self):
        ...
        if (self.lookahead.data["TYPE"] == "IDENTIFIER" and data_next.data["value"] == "++"):
            ...
            self.match("=")
            self.expression()
        elif (data == '!' or self.lookahead.data['TYPE'] == 'IDENTIFIER' or data == '(' or self.lookahead.data[
            'TYPE'] in CONST):
            self.simpleExp()
        else:
    ...
    def arglist(self):
        ...
        if (data == '!' or self.lookahead.data['TYPE'] == 'IDENTIFIER' or data == '(' or self.lookahead.data[
            'TYPE'] in CONST):
            self.expression()
            self.arglist_()
        else:
    ...
    def stmtlist(self):
        ...
        if (data in ['!', '(', 'if', 'cout', 'cin', 'while', 'for', 'switch', 'return', 'break'] or data in datatype or
                self.lookahead.data["TYPE"] in ["IDENTIFIER", CONST]):
            self.statment()
            self.stmtlist_()
        else:
